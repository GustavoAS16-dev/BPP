<?php
    ...
    if(isset($_POST["submit"]))
    {
        ...
        else
        {
            ...
            {
                echo("<p class=\"error_message_1\">AS senhas informadas não correpondem entre si</p>");
            }
        }
    } */
?>
        ...
        <section id="login_1">
            <div class="form_1_div1">
                ...
                <form name="form_1" id="form_1" class="c_form_1" autofocus method="post" action="../scripts/cadastrar_1.php">
                    ...
                    <br />
                    <br />
                    <input type="password" name="senha_2" placeholder="Repita a senha" class="input_text_1" required />
                    <br />
                    <br />
                    <br />
                    ...
                    <br />
                    <br />
                    <input type="submit" name="send_1" value="Cadastrar" class="input_submit_1" href="../scripts/cadastrar_1.php" />
                    <br />
                    <br />
                    <br />
                    <br />
